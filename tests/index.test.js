...
describe('react-jss', function () {
  ...
  describe('.injectSheet()', function () {
    ...
    it('should attach and detach a sheet', function () {
      (0, _reactDom.render)(_react2['default'].createElement(MyComponent, null), node);
  ...
  describe('injectSheet() option "inject"', function () {
    ...
    it('should inject all by default', function () {
      (0, _expect2['default'])(getInjected()).to.eql(['classes', 'theme']);
    });
    ...
    it('should inject classes and theme', function () {
      (0, _expect2['default'])(getInjected({ inject: ['classes', 'theme'] })).to.eql(['classes', 'theme']);
    });
  });
  ...
  describe('.injectSheet() classes prop', function () {
    ...
    beforeEach(function () {
      InnerComponent = function InnerComponent(_ref) {
    ...
    it('should not overwrite existing classes property', function () {
      ...
      (0, _reactDom.render)(_react2['default'].createElement(MyComponent, { classes: classes }), node);
      (0, _expect2['default'])(passedClasses).to.equal(classes);
    });

    it('should be prefixed by the parent injected component\'s name', function () {
      (0, _reactDom.render)(_react2['default'].createElement(MyComponent, null), node);
  ...
  describe('with JssProvider for SSR', function () {
    ...
    it('should use Jss istance from the context', function () {
      ...
      var MyComponent = injectSheet({}, { inject: ['sheet'] })(function (_ref2) {
    ...
    it('should use classNamePrefix', function () {
      ...
      (0, _expect2['default'])(registry.toString()).to.be((0, _commonTags.stripIndent)(_templateObject11));
    });
  });
  ...
  describe('function values', function () {
    ...
    it('should have correct meta attribute', function () {
      ...
      (0, _expect2['default'])(meta0).to.be('InnerComponent, Unthemed, Static');
      (0, _expect2['default'])(meta1).to.be('InnerComponent, Unthemed, Dynamic');
    });
    ...
    it('should reuse static sheet, but generate separate dynamic once', function () {
      (0, _reactDom.render)(_react2['default'].createElement(
        'div',
        null,
        _react2['default'].createElement(MyComponent, { height: 2 }),
        _react2['default'].createElement(MyComponent, { height: 3 })
      ), node);
    ...
    it('should use the default value', function () {
      var node0 = (0, _reactDom.render)(_react2['default'].createElement(MyComponent, null), node);
    ...
    it('should generate different dynamic values', function () {
      var componentNode = (0, _reactDom.render)(_react2['default'].createElement(
        'div',
        null,
        _react2['default'].createElement(MyComponent, { height: 10 }),
        _react2['default'].createElement(MyComponent, { height: 20 })
      ), node);
        ...
        _createClass(Container, [{
          ...
          value: function render() {
            ...
            return _react2['default'].createElement(
              'div',
              null,
              _react2['default'].createElement(MyComponent, { height: height }),
              _react2['default'].createElement(MyComponent, { height: height * 2 })
            );
          }
        }]);
  ...
  describe('theming', function () {
    ...
    it('should have correct meta attribute for static styles', function () {
      ...
      var styles = document.querySelectorAll('style');
      var meta0 = styles[0].getAttribute('data-meta');
      (0, _expect2['default'])(meta0).to.be('NoRenderer, Themed, Static');
      var meta1 = styles[1].getAttribute('data-meta');
      (0, _expect2['default'])(meta1).to.be('NoRenderer, Themed, Dynamic');
    });
    ...
    it('with JssProvider should render two different sheets', function () {
      ...
      (0, _expect2['default'])(actual).to.be((0, _commonTags.stripIndent)(_templateObject9));
    });
